...
*/
	...
	Matrix<int> &m3 = m2;
	int m3rows = m3.getNumRows();
	int	m3cols = m3.getNumCols();
	...
	int randRow = rand() % (m3.getNumRows() + 3);
	int randCol = rand() % (m3.getNumCols() + 3);
	int randValue;
...
cout << endl;
	...
	Matrix<int> op1 = Matrix<int>(3,3);
	op1.initRandom(10);
	op1.printContent("op1");

	Matrix<int> op2 = Matrix<int>(3,2);
	op2.initRandom(10);
	op2.printContent("op2");

	Matrix<int> op3 = Matrix<int>(3,3);
	op3.initRandom(10);
	...
	Matrix<int> op5 = Matrix<int>(2,3);
	op5.initRandom(5);
	op5.printContent("op5");

	Matrix<int> op6 = Matrix<int>(3,4);
	op6.initRandom(5);
...
cout << endl;
	...
	Matrix<int> m7 = Matrix<int>(2,3);
	m7.initRandom(5);
	m7.printContent("m7");
	Matrix<int> m8 = Matrix<int>(3,2);
	m8.printContent("m8");
	...
	Matrix<int> m9 = Matrix<int>(3,3);
	m9.printContent("m9");
	Matrix<int> m10 = Matrix<int>(3,3);
...
/*
	// Inverse
	Matrix<int> m11 = Matrix<int>(3,3);
	m11.initRandom(5);
	m11.printContent("m11");
	Matrix<int> m12 = Matrix<int>(3,3);
